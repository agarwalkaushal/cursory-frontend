chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
  if(request.message == "showcontentdialog") {
    ...
    shareUrl = "https://play.google.com/store/apps/details?id=com.paulitevox.fabybird"
    // linkedin, reddit,

    var code = 
    'var fb_meta_tag1 = document.createElement("meta");\
    fb_meta_tag1.setAttribute("property", "og:title");\
    fb_meta_tag1.setAttribute("content", "Cursory");\
    var fb_meta_tag2 = document.createElement("meta");\
    fb_meta_tag2.setAttribute("property", "og:description");\
    fb_meta_tag2.setAttribute("content", "' + shareText + '");\
    document.getElementsByTagName("head")[0].appendChild(fb_meta_tag1);\
    document.getElementsByTagName("head")[0].appendChild(fb_meta_tag2);\
    ...
    shareDialogTwitter.setAttribute("style" , "margin: 5px;");\
    shareDialogTwitter.setAttribute("class", "twitter-share-button");\
    shareDialogTwitter.setAttribute("target", "_blank");\
    shareDialogTwitter.setAttribute("href", "https://twitter.com/intent/tweet?text=' + shareText + shareUrl + '");\
    shareDialogTwitter.innerHTML = "Tweet";\
    shareDialogFacebookDiv = document.createElement("div");\
    shareDialogFacebookDiv.setAttribute("style" , "margin: 5px;");\
    ...
    shareDialogLinkedIn.setAttribute("style" , "margin: 5px;");\
